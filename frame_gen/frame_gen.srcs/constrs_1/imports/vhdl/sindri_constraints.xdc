...
# Anders Stengaard Sørensen  January 2026
# V0.21 
# History: 
...
# 25MHz clock                    IOBANK34-positive (MRCC-T2)
# --- The following define the 25MHz clk input pin/type/period/waveform and group
set_property PACKAGE_PIN G11     [get_ports CLK25_I]
set_property IOSTANDARD LVCMOS33 [get_ports CLK25_I]
create_clock -period 40.000 -name CLK25_I -waveform {0.000 20.000} [get_ports CLK25_I]
set_clock_groups -name XCLK -asynchronous -group [get_clocks CLK25_I]
