...
--
-- History:
-- 2019 Generated as generic 48MHZ generator, using 1GHZ PLL frequency
-- 2026 Can not obtain 1GHz from 12 MHz input (Sindri)
--      changed to use 768MHz PLL frequency
...
MMCME2_BASE_inst : MMCME2_BASE
  generic map (
    BANDWIDTH => "OPTIMIZED",  
    CLKFBOUT_MULT_F => CLK_I_PERIOD*0.768, -- Always arrive a 768 MHz PLL frequency
    CLKFBOUT_PHASE => 0.0,  -- no phase change
    CLKIN1_PERIOD => CLK_I_PERIOD*0.768,  -- Specify period for synthesis checking
    -- CLKOUT0..5_DIVIDE : Divide amount for each CLKOUT (1-128)
    CLKOUT0_DIVIDE_F =>16.0, -- 768MHZ/16 = 48MHz
