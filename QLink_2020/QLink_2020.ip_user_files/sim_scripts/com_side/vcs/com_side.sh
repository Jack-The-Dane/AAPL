...
compile()
{
  ...
  vlogan -work xlconstant_v1_1_10 $vlogan_opts +v2k +incdir+"../../../../../../../Vivado/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xlconcat_v2_1_7 $vlogan_opts +v2k +incdir+"../../../../../../../Vivado/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Documents/APPL_project_tetris/QLink_2020/QLink_2020.cache/compile_simlib/vcs"
  fi
