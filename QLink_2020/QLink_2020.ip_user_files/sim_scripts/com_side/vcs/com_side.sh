...
design_libs=(xpm xil_defaultlib blk_mem_gen_v8_4_12 xlconstant_v1_1_10 xlconcat_v2_1_7)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xlconstant_v1_1_10 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xlconcat_v2_1_7 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.com_side xil_defaultlib.glbl -o com_side_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./com_side_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/shared/Semester8/AAPL/project/QLink_2020/QLink_2020.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key com_side_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc com_side_simv.daidir vcs_lib c.obj)
