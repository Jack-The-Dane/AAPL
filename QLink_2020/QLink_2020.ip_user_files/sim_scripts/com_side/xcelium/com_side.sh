...
#
# Script generated by Vivado on Tue May 05 14:53:51 CEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : com_side.sh
...
#
# Usage        : com_side.sh
#                com_side.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                com_side.sh [-rerun]
#                com_side.sh [-reset_run]
#                com_side.sh [-clean]
#                com_side.sh [-reset_log]
#                com_side.sh [-help]
#
...
#                script (type 'com_side.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_12 -libname xlconstant_v1_1_10 -libname xlconcat_v2_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib blk_mem_gen_v8_4_12 xlconstant_v1_1_10 xlconcat_v2_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "com_side.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./com_side.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xlconstant_v1_1_10 $xmvlog_opts +incdir+"../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xlconcat_v2_1_7 $xmvlog_opts +incdir+"../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.com_side xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.com_side -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/shared/Semester8/AAPL/project/QLink_2020/QLink_2020.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log com_side_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./com_side.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: com_side.sh [-help]\n\
Usage: com_side.sh [-step]\n\
Usage: com_side.sh [-lib_map_path]\n\
Usage: com_side.sh [-rerun]\n\
Usage: com_side.sh [-reset_run]\n\
Usage: com_side.sh [-clean]\n\
Usage: com_side.sh [-reset_log]\n\
Usage: com_side.sh [-keep_index]\n\
Usage: com_side.sh [-noclean_files]\n\n\
