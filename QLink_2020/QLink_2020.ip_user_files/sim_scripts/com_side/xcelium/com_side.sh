...
#
# Script generated by Vivado on Mon May 04 11:26:52 CEST 2026
...
compile()
{
  ...
  xmvlog -work xlconstant_v1_1_10 $xmvlog_opts +incdir+"../../../../../../../Vivado/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xlconcat_v2_1_7 $xmvlog_opts +incdir+"../../../../../../../Vivado/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Documents/APPL_project_tetris/QLink_2020/QLink_2020.cache/compile_simlib/xcelium"
  fi
