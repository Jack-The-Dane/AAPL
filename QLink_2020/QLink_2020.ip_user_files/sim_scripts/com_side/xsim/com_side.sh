...
simulate()
{
  xsim com_side -key {Behavioral:sim_1:Functional:com_side} -tclbatch cmd.tcl -protoinst "protoinst_files/com_side.protoinst" -protoinst "protoinst_files/block_test_inst_0.protoinst" -log simulate.log
}
