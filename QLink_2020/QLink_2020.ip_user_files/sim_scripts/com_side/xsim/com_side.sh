...
export RDI_DATADIR="/home/kasper-ubuntu/Vivado/2025.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L xlconstant_v1_1_10 -L xlconcat_v2_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot com_side xil_defaultlib.com_side xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim com_side -key {Behavioral:sim_1:Functional:com_side} -tclbatch cmd.tcl -protoinst "protoinst_files/com_side.protoinst" -protoinst "protoinst_files/top_level.protoinst" -protoinst "protoinst_files/main_top.protoinst" -protoinst "protoinst_files/block_test.protoinst" -protoinst "protoinst_files/block_test_inst_0.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Vivado/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb com_side.wdb xsim.dir libdpi.so)
