...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot main_top xil_defaultlib.main_top xil_defaultlib.glbl -log elaborate.log
}
