...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_10 -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot main_top xil_defaultlib.main_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim main_top -key {Behavioral:sim_1:Functional:main_top} -tclbatch cmd.tcl -protoinst "protoinst_files/com_side.protoinst" -protoinst "protoinst_files/main_top.protoinst" -protoinst "protoinst_files/block_test_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb main_top.wdb xsim.dir libdpi.so)
