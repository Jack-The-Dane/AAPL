...
design_libs=(xpm xlconstant_v1_1_10 xil_defaultlib blk_mem_gen_v8_4_12)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.main_top xil_defaultlib.glbl -o main_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./main_top_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key main_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc main_top_simv.daidir vcs_lib c.obj)
