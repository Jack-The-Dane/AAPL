...
#
# Script generated by Vivado on Mon May 11 13:09:51 CEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : main_top.sh
...
#
# Usage        : main_top.sh
#                main_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                main_top.sh [-rerun]
#                main_top.sh [-reset_run]
#                main_top.sh [-clean]
#                main_top.sh [-reset_log]
#                main_top.sh [-help]
#
...
#                script (type 'main_top.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xlconstant_v1_1_10 -libname xil_defaultlib -libname blk_mem_gen_v8_4_12 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xlconstant_v1_1_10 xil_defaultlib blk_mem_gen_v8_4_12)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "main_top.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./main_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.main_top xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.main_top -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log main_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./main_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: main_top.sh [-help]\n\
Usage: main_top.sh [-step]\n\
Usage: main_top.sh [-lib_map_path]\n\
Usage: main_top.sh [-rerun]\n\
Usage: main_top.sh [-reset_run]\n\
Usage: main_top.sh [-clean]\n\
Usage: main_top.sh [-reset_log]\n\
Usage: main_top.sh [-keep_index]\n\
Usage: main_top.sh [-noclean_files]\n\n\
