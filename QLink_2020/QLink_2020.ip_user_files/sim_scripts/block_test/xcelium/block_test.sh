...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.block_test
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.block_test -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Documents/AAPL_project/QLink_2020/QLink_2020.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log block_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
