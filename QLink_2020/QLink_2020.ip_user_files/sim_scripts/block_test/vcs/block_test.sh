...
#
# Script generated by Vivado on Thu Apr 02 11:00:24 CEST 2026
...
# script info
echo -e "block_test.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_test -o block_test_simv
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Documents/AAPL_project/QLink_2020/QLink_2020.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key block_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc block_test_simv.daidir vcs_lib c.obj)
...
Usage: block_test.sh [-rerun]\n\
Usage: block_test.sh [-reset_run]\n\
Usage: block_test.sh [-clean]\n\
