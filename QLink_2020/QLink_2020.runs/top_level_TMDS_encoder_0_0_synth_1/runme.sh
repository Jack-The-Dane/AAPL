...
HD_PWD='/home/kasper-ubuntu/Documents/APPL_project_tetris/QLink_2020/QLink_2020.runs/top_level_TMDS_encoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_TMDS_encoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_TMDS_encoder_0_0.tcl
