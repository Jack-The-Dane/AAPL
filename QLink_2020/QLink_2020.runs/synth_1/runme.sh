...
HD_PWD='/home/jacob/shared/Semester8/AAPL/project/QLink_2020/QLink_2020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_top_wrapper.tcl
