...
synth_design -top main_top_wrapper -part xc7s15ftgb196-1
...
write_checkpoint -force -noxdef main_top_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file main_top_wrapper_utilization_synth.rpt -pb main_top_wrapper_utilization_synth.pb"  } 
