...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "hsyncActive" -parent ${Page_0}
  ipgui::add_param $IPINST -name "prefetch_idx" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "vsyncActive" -parent ${Page_0}
...
proc update_PARAM_VALUE.hsyncActive { PARAM_VALUE.hsyncActive } {
	# Procedure called to update hsyncActive when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.hsyncActive { PARAM_VALUE.hsyncActive } {
	# Procedure called to validate hsyncActive
	return true
}

proc update_PARAM_VALUE.prefetch_idx { PARAM_VALUE.prefetch_idx } {
	# Procedure called to update prefetch_idx when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.prefetch_idx { PARAM_VALUE.prefetch_idx } {
	# Procedure called to validate prefetch_idx
	return true
}
...
proc update_PARAM_VALUE.vsyncActive { PARAM_VALUE.vsyncActive } {
	# Procedure called to update vsyncActive when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.vsyncActive { PARAM_VALUE.vsyncActive } {
	# Procedure called to validate vsyncActive
	return true
}
...
proc update_MODELPARAM_VALUE.hsyncActive { MODELPARAM_VALUE.hsyncActive PARAM_VALUE.hsyncActive } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.hsyncActive}] ${MODELPARAM_VALUE.hsyncActive}
}
...
proc update_MODELPARAM_VALUE.vsyncActive { MODELPARAM_VALUE.vsyncActive PARAM_VALUE.vsyncActive } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.vsyncActive}] ${MODELPARAM_VALUE.vsyncActive}
}

proc update_MODELPARAM_VALUE.prefetch_idx { MODELPARAM_VALUE.prefetch_idx PARAM_VALUE.prefetch_idx } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.prefetch_idx}] ${MODELPARAM_VALUE.prefetch_idx}
}
