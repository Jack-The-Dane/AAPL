...
HD_PWD='/home/kasper-ubuntu/Documents/AAPL_project/vhdl/pl_side/pl_side.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log button_LED_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source button_LED_wrapper.tcl -notrace
