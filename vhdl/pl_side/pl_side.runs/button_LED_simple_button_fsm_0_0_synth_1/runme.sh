...
HD_PWD='/home/kasper-ubuntu/Documents/AAPL_project/vhdl/pl_side/pl_side.runs/button_LED_simple_button_fsm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_LED_simple_button_fsm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_LED_simple_button_fsm_0_0.tcl
