...
design_libs=(xlconstant_v1_1_10 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.button_LED xil_defaultlib.glbl -o button_LED_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./button_LED_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Documents/AAPL_project/vhdl/pl_side/pl_side.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key button_LED_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc button_LED_simv.daidir vcs_lib c.obj)
