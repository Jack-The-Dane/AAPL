...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot button_LED xil_defaultlib.button_LED xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim button_LED -key {Behavioral:sim_1:Functional:button_LED} -tclbatch cmd.tcl -protoinst "protoinst_files/button_LED.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb button_LED.wdb xsim.dir libdpi.so)
