...
#
# Script generated by Vivado on Sat Feb 21 14:06:40 CET 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : button_LED.sh
...
#
# Usage        : button_LED.sh
#                button_LED.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                button_LED.sh [-rerun]
#                button_LED.sh [-reset_run]
#                button_LED.sh [-clean]
#                button_LED.sh [-reset_log]
#                button_LED.sh [-help]
#
...
#                script (type 'button_LED.sh -help' for more information).
#
...
design_libs_elab="-libname xlconstant_v1_1_10 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xlconstant_v1_1_10 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "button_LED.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./button_LED.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.button_LED xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.button_LED -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kasper-ubuntu/Documents/AAPL_project/vhdl/pl_side/pl_side.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log button_LED_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./button_LED.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: button_LED.sh [-help]\n\
Usage: button_LED.sh [-step]\n\
Usage: button_LED.sh [-lib_map_path]\n\
Usage: button_LED.sh [-rerun]\n\
Usage: button_LED.sh [-reset_run]\n\
Usage: button_LED.sh [-clean]\n\
Usage: button_LED.sh [-reset_log]\n\
Usage: button_LED.sh [-keep_index]\n\
Usage: button_LED.sh [-noclean_files]\n\n\
