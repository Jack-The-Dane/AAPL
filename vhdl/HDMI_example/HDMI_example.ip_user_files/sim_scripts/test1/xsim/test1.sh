...
#
# Script generated by Vivado on Wed Mar 04 15:03:47 CET 2026
...
#
# Usage        : test1.sh
#                test1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test1.sh [-rerun]
#                test1.sh [-reset_run]
#                test1.sh [-clean]
#                test1.sh [-reset_log]
...
# script info
echo -e "test1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot test1 xil_defaultlib.test1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim test1 -key {Behavioral:sim_1:Functional:test1} -tclbatch cmd.tcl -protoinst "protoinst_files/test1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb test1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./test1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: test1.sh [-help]\n\
Usage: test1.sh [-step]\n\
Usage: test1.sh [-lib_map_path]\n\
Usage: test1.sh [-rerun]\n\
Usage: test1.sh [-reset_run]\n\
Usage: test1.sh [-clean]\n\
Usage: test1.sh [-reset_log]\n\
Usage: test1.sh [-keep_index]\n\
Usage: test1.sh [-noclean_files]\n\n\
