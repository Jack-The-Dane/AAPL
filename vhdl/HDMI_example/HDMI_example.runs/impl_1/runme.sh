...
HD_PWD='/home/jacob/shared/Semester8/AAPL/project/vhdl/HDMI_example/HDMI_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OSERDES_10_to_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OSERDES_10_to_1.tcl -notrace
