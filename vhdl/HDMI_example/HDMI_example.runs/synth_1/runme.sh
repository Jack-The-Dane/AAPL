...
HD_PWD='/home/jacob/shared/Semester8/AAPL/project/vhdl/HDMI_example/HDMI_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OSERDES_10_to_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OSERDES_10_to_1.tcl
